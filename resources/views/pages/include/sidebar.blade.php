             ...
             <div id="halim-ajax-popular-post" class="popular-post">
                 ...
                 <div class="item post-37176">
                     ...
                     <div class="viewsCount" style="color: #9d9d9d;">
                         @if ($hot_sidebar->phude == 0)
                         VietSub
                         @elseif ($hot_sidebar->phude == 1)
                         Thuyết minh
                         @else
                         Không
                         @endif
    ...
    <div id="halim_tab_popular_videos-widget-7" class="widget halim_tab_popular_videos-widget">
       ...
       <section class="tab-content">
          <div role="tabpanel" class="tab-pane active halim-ajax-popular-post">
             <div class="halim-ajax-popular-post-loading hidden"></div>
             <div id="halim-ajax-popular-post" class="popular-post">
                 @foreach ($phimhot_trailer as $key => $trailer )
                 <div class="item post-37176">
                     <a href="{{route('movie',$trailer->slug)}}" title="CHỊ MƯỜI BA: BA NGÀY SINH TỬ">
                        <div class="item-link">
                           <img src="{{asset('uploads/movie/'.$trailer->image)}}" class="lazy post-thumb" alt="CHỊ MƯỜI BA: BA NGÀY SINH TỬ" title="CHỊ MƯỜI BA: BA NGÀY SINH TỬ" />
                           <span class="is_trailer">
