    ...
    <div class="row container" id="wrapper">
        <div class="halim-panel-filter">
           <div class="panel-heading">
              <div class="row">
                <div class="col-xs-6">
                    <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{$movie->title}}</a> » <a href="{{route('country',[$movie->country->slug])}}"><span class="breadcrumb_last" aria-current="page">{{$movie->country->title}}</span></a></span> » <span>{{$movie->year}}</span></span></div>
                </div>
              </div>
           </div>
        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
           ...
           <article class="thumb grid-item post-38494">
            ...
            <a class="halim-thumb" href="{{route('movie',$rela->slug)}}" title="Câu Chuyện Kinh Dị Cổ Điển">
            <figure><img class="lazy img-responsive" src="{{asset('uploads/movie/'.$rela->image)}}" alt="Câu Chuyện Kinh Dị Cổ Điển" title="Câu Chuyện Kinh Dị Cổ Điển"></figure>
            <span class="status">
                @if ($rela->resolution == 0)
                HD
                @elseif ($rela->resolution == 1)
                SD
                @else
                FullHD
                @endif
                ...
                @if ($rela->phude == 0)
                VietSub - {{$rela->sotap}}/{{$rela->sotap}} Tập
                @elseif ($rela->phude == 1)
                Thuyết minh - {{$rela->sotap}}/{{$rela->sotap}} Tập
                @else
                Không - {{$rela->sotap}}/{{$rela->sotap}} Tập
                @endif
            </span> <div class="icon_overlay"></div>
            <div class="halim-post-title-box">
            <div class="halim-post-title ">
            <p class="entry-title">{{$rela->title}}</p><p class="original_title">{{$rela->title}}</p>
            </div>
            </div>
            </a>
            </div>
