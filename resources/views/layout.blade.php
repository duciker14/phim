...
<html lang="vi">
   <head>
      ...
      <style>#header .site-title {background: url(https://i.ibb.co/QngGcVm/H-i-i-1.png) no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
   </head>
   <body class="home blog halimthemes halimmovies" data-masonry="">
                        ...
                        {{-- <form id="search-form-pc" name="halimForm" role="search" action="" method="GET"> --}}
                           <div class="form-group form-timkiem">
                                <div class="input-group col-xs-12">
                                    ...
                                    <input id="timkiem" type="text" name="search" style="width: 350px;height:35px;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;" placeholder="Tìm kiếm..." autocomplete="off" required>
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="img-responsive" src="https://i.ibb.co/QngGcVm/H-i-i-1.png" alt="Phim hay 2021- Xem phim hay nhất" />
                  </div>
                  Liên hệ QC: <a href="https://www.facebook.com/duc1ker/" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">NGUYỄN QUANG ĐỨC</a>
               </div>
            </div>
         </div>
      </footer>
      ...
      <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0" nonce="O4KnKeqL"></script>
      <script type="text/javascript">
                    ...
                    $.getJSON('/json/movies.json',function(data){
                        $.each(data,function(key,value){
                            if(value.title.search(expression)!= -1){ // || value.description.search(expression) != -1
                                // $('#result').append('<li class="list-group-item link-class" style="cursor:pointer"><img height="40" width="40" src="/uploads/movie/'+value.image+'">'+value.title+'<br> |<span>'+value.description+'</span></li>')
